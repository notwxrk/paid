...
def get_sqlite_connection():
    ...
    try:
        ...
        print("✅ SQLite ga muvaffaqiyatli ulandi")
        return conn
    except Exception as e:
...
def init_db():
    try:
        ...
        if postgres_conn:
            ...
            ''')
            print("✅ Products table yaratildi/yoki mavjud")
            ...
            ''')
            print("✅ Orders table yaratildi/yoki mavjud")
        ...
        print("🔄 SQLite backup ishga tushirilmoqda...")
        sqlite_conn = get_sqlite_connection()
        if sqlite_conn:
            print("✅ SQLite ga ulandi")
            ...
            ''')
            print("✅ SQLite Products table yaratildi")
            ...
            ''')
            print("✅ SQLite Orders table yaratildi")
